...
-- 1. Nhóm chửi thề trực diện / Liên quan đến phụ huynh (Tần suất cực cao)
('dit me', 'phrase', '***', 1),
('dit cu', 'phrase', '***', 1),
('du ma', 'phrase', '***', 1),
('du me', 'phrase', '***', 1),
...
-- 2. Nhóm bộ phận sinh dục / Hành vi tục tĩu
('cai lon', 'phrase', '***', 1),
('cai loz', 'phrase', '***', 1),
('con cac', 'phrase', '***', 1),
('cai buoi', 'phrase', '***', 1),
...
-- 3. Nhóm lăng mạ, miệt thị nhân phẩm, súc vật hóa
('oc cho', 'phrase', '***', 1),
('nao cho', 'phrase', '***', 1),
('cho de', 'phrase', '***', 1),
('thang cho', 'phrase', '***', 1),
...
-- 4. Nhóm tệ nạn, mờ ám, miệt thị giới tính
('diem thu', 'phrase', '***', 1),
('lam pho', 'phrase', '***', 1),
('do cave', 'phrase', '***', 1),
('con diem', 'phrase', '***', 1),
...
-- 5. Nhóm viết tắt cực đoan (Đã lọc False Positive)
('dm', 'abbreviation', '***', 1),
('dcm', 'abbreviation', '***', 1),
('dkm', 'abbreviation', '***', 1),
('dmm', 'abbreviation', '***', 1),
