...
<section class="py-20 bg-gradient-to-br from-primary/5 via-white to-secondary/5">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-4xl mx-auto mb-14 reveal">
            ...
            <h1 class="text-5xl md:text-6xl font-black mb-5">Về <span class="gradient-text"><?= e($siteName) ?></span></h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            <div class="reveal-left">
                <img src="<?= e($introImage) ?>" alt="<?= e($siteName) ?>" class="w-full rounded-3xl shadow-2xl object-cover min-h-[320px]">
            </div>
