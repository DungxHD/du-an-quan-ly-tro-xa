...
<section class="relative min-h-[700px] flex items-center justify-center overflow-hidden">
    <div class="hero-bg absolute inset-0 bg-cover bg-center" style="background-image: url('<?= e($heroImage) ?>');"></div>
    ...
    <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-white">
        <div class="max-w-4xl text-center mx-auto">
            ...
            <p class="text-lg md:text-2xl text-gray-200 max-w-3xl mx-auto mb-10 reveal">
                <?= e($siteDescription) ?>
            </p>
...
<section class="py-20 bg-surface">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-14 reveal">
            <h2 class="text-4xl md:text-5xl font-bold mb-4">Tiện ích đang có tại <span class="gradient-text"><?= e($siteName) ?></span></h2>
