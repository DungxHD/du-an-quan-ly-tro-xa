            ...
            [
                ...
                'fields' => [
                    [
                        ...
                        'min' => 0,
                        'placeholder' => '15',
                        'tooltip' => 'Người thuê phải ở tối thiểu bao nhiêu ngày mới được đánh giá phòng.',
                    ],
                    [
                        'key' => 'comment_edit_hours',
                        'label' => 'Thời gian được sửa',
                        'type' => 'number',
                        'group' => 'moderation',
                        'default' => '24',
                        'min' => 1,
                        'placeholder' => '24',
                        'suffix' => 'giờ',
                        'tooltip' => 'Khoảng thời gian sau khi gửi mà người thuê còn được sửa đánh giá. Sau đó chỉ còn quyền xóa (không giới hạn thời gian).',
                    ],
                ],
            ],
            [
