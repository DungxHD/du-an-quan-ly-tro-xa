...
class Database {
    ...
    private static function bootFallbackData() {
        ...
        self::$fallbackData = [
            ...
            'rooms' => [
                ['id' => 1, 'building_id' => 1, 'floor_id' => 1, 'name' => 'A101', 'floor' => 1, 'price' => 3200000, 'area' => 20, 'max_occupancy' => 2, 'description' => 'Phòng có cửa sổ lớn, máy lạnh, nước nóng và bàn học.', 'status' => 'available', 'thumbnail' => 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=900', 'views' => 126, 'notice_given' => 0, 'expected_vacant_date' => null],
                ['id' => 2, 'building_id' => 1, 'floor_id' => 2, 'name' => 'A202', 'floor' => 2, 'price' => 3600000, 'area' => 24, 'max_occupancy' => 3, 'description' => 'Phòng rộng, có ban công nhỏ và khu bếp gọn gàng.', 'status' => 'rented', 'thumbnail' => 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=900', 'views' => 95, 'notice_given' => 1, 'expected_vacant_date' => date('Y-m-d', strtotime('+10 days'))],
                ['id' => 3, 'building_id' => 2, 'floor_id' => 3, 'name' => 'B103', 'floor' => 1, 'price' => 4100000, 'area' => 28, 'max_occupancy' => 2, 'description' => 'Phòng riêng tư, phù hợp người đi làm, có máy giặt chung theo tầng.', 'status' => 'available', 'thumbnail' => 'https://images.unsplash.com/photo-1484154218962-a197022b5858?w=900', 'views' => 188, 'notice_given' => 0, 'expected_vacant_date' => null],
                ['id' => 4, 'building_id' => 2, 'floor_id' => 4, 'name' => 'B205', 'floor' => 2, 'price' => 4300000, 'area' => 30, 'max_occupancy' => 3, 'description' => 'Không gian yên tĩnh, nội thất cơ bản mới.', 'status' => 'maintenance', 'thumbnail' => 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=900', 'views' => 42, 'notice_given' => 0, 'expected_vacant_date' => null],
                ['id' => 5, 'building_id' => 3, 'floor_id' => 6, 'name' => 'C301', 'floor' => 3, 'price' => 5200000, 'area' => 32, 'max_occupancy' => 2, 'description' => 'Studio cao cấp, đầy đủ nội thất và khu bếp riêng.', 'status' => 'rented', 'thumbnail' => 'https://images.unsplash.com/photo-1494526585095-c41746248156?w=900', 'views' => 210, 'notice_given' => 1, 'expected_vacant_date' => date('Y-m-d', strtotime('+5 days'))],
                ['id' => 6, 'building_id' => 3, 'floor_id' => 5, 'name' => 'C101', 'floor' => 1, 'price' => 4700000, 'area' => 26, 'max_occupancy' => 2, 'description' => 'Phòng studio tiêu chuẩn, vào ở ngay.', 'status' => 'available', 'thumbnail' => 'https://images.unsplash.com/photo-1460317442991-0ec209397118?w=900', 'views' => 162, 'notice_given' => 0, 'expected_vacant_date' => null],
            ],
            'users' => [
