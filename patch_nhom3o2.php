...
// B: thay grid2 (cach tinh + doi tuong) bang cach-tinh-only  [LAM TRUOC]
...
// C: xoa tooltip block  [LAM SAU B/A de con anchor]
...
// Row: pendDel var + badge + hoan tac (tu dong if/endif, khong treo PHP)
rep($c,
